                  ...
                  <div className="space-y-4">
                    ...
                    {current.criteria.map((c, ci) => (
                      <article key={c.name} id={'criterion-' + ci} className="rounded-xl border bg-white p-6 scroll-mt-4">
                              ...
                              {bv && (<>
                                ...
                                <table className="w-full text-xs border-collapse mb-3">
                                  ...
                                  <tbody>
                                    ...
                                    <tr><td className="p-1.5 border">Other Personnel?</td><td className="p-1.5 border">{bv.other_personnel === 'None' || !bv.other_personnel ? <span className="text-xs text-slate-500">None</span> : <span className="text-xs text-slate-700">{bv.other_personnel}</span>}</td><td className="p-1.5 border">Allowed</td><td className="p-1.5 border">{bv.other_personnel === 'None' || !bv.other_personnel ? <PassBadge /> : <span className="inline-block rounded bg-amber-100 text-amber-800 px-1.5 py-0.5 text-[10px] font-bold">REVIEW</span>}</td></tr>
                                  </tbody>
                                </table>
                        ...
                        {/* Old review table removed — use NOFO Evaluation Questions above */}
                      </article>
                    ))}
