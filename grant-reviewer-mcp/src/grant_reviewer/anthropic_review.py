...
def score_application_with_claude(application: Path, criteria: list[dict[str, Any]], agency: str, guidance: str = "") -> dict[str, Any]:
    ...
    if not api_key:
        raise RuntimeError("ANTHROPIC_API_KEY is not configured. Add it to backend/.env and restart the API.")
    ...
    payload = {"model": os.getenv("ANTHROPIC_MODEL", "claude-sonnet-4-6-20250514"), "max_tokens": 12000, "temperature": 0, "system": SYSTEM_PROMPT,
